...
banner_url: 'https://i.postimg.cc/28zPk4gS/dual-boot-bluetooth-sync.jpg'
banner_pos: '0 10%'
---
# 前言
...
3. 在 Windows 找到共用金鑰
    1. 開啟「登錄編輯程式」
        ![](https://i.postimg.cc/SNyY67Z9/registry.jpg)
    2. 找到 `HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\BTHPORT\Parameters\Keys` ，並先給予自己權限
        ![](https://i.postimg.cc/sgxB8fCD/registry-permission-1.jpg)
        ![](https://i.postimg.cc/5NnYnYGR/registry-permission-2.jpg)
        ![](https://i.postimg.cc/tRdVnmzy/registry-permission-3.jpg)
    3. 重新開啟登錄編輯程式後，就能夠看到各個已配對裝置的連線金鑰。
        記下欲同步的裝置的金鑰，可以先截圖存起來
        ![](https://i.postimg.cc/QCD0D4pm/registry-key-value.jpg)
...
# 結語
當照著以上的方法做過後，已配對的藍牙裝置就可以在兩個系統之間正常使用了。
